  ...
  return (
    <Layout>
      <div>
        ...
        {renderDraggableWindow("Navigation", 
          <>
            <NavigationControls destination={destination} setDestination={setDestination} onEngage={handleEngage} />
            <CelestialNavigator celestialId={celestialId} onCelestialChange={handleCelestialChange} />
          </>
        )}
        {renderDraggableWindow("Viewport", <Viewport celestialId={celestialId} />)}
      </div>
    </Layout>
  );
};
